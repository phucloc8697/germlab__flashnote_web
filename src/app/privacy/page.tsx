      ...
      <div className="flex-1 flex flex-col bg-main content">
        ...
        <div className="container w-screen min-h-screen flex flex-col mx-auto py-20 gap-12">
          ...
          <div className="flex flex-col gap-4">
            <p>
              Germlab built the Flashnote app as a Free app. This SERVICE is provided by Germlab at
            ...
            <p>
              ...
              Conditions, which are accessible at Flashnote unless otherwise defined in this Privacy
              Policy.
            </p>
          </div>
          <div className="flex flex-col gap-4">
